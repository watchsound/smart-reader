...
class RecordRecent {
  static async setRecent(bookKey: string) {
    const bookArr0 = (await customStorage.getItem('recentBooks')) as string;
    const bookArr =
    ...
    customStorage.setItem('recentBooks', JSON.stringify(bookArr));
  }
