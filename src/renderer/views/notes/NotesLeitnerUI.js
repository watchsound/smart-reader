...
import NotesLeitnerListView from './NotesLeitnerListView';
      ...
      <TabContext value={tabValue}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList onChange={handleTabChange}>
            <Tab label="Notes For Review" value="1" sx={{ fontSize: '11px' }} />
            <Tab label="Notes In Query" value="2" sx={{ fontSize: '11px' }} />
          </TabList>
        </Box>
        <MyTabPanel value="1">
          <NotesLeitnerListView isReviewDue />
        </MyTabPanel>
        <MyTabPanel value="2">
          <NotesLeitnerListView isReviewDue={false} />
        </MyTabPanel>
      </TabContext>
    </Box>
  );
